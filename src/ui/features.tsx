...
const Features = () => {
    ...
    return(
        <div className="h-fit min-h-[95vh] w-[90%] md:w-[80%] mx-auto relative mt-24 flex flex-col gap-5">
            ...
            <p className="text-lg md:w-[55%] text-gray-500 leading-8 tracking-wider">Textflex delivers trusted virtual phone numbers from a wide range of countries, enabling seamless SMS reception at competitive rates designed for global accessibility</p>
