...
const Hero = () => {
    return(
        <div className="w-full bg-[linear-gradient(to_right,_#f9fbfd,_#eef4fd)]  h-fit  min-h-screen grid place-items-center relative z-10 mt-24 dark:text-black">
                    ...
                    <div className="w-[95%]  flex">
                       <Link  className="bg-[#0032a5] w-[40%] md:w-[23%] h-11 rounded-xl grid text-lg tracking-widest  place-content-center text-white " to="/signup/:1">
                        ...
                        <Link className="md:w-[23%] w-[40%] h-11 text-sm grid place-content-center" to="/login">
                            <Button
                             content={<span className="flex w-full items-center gap-2 justify-center tracking-widest text-lg">Login <ArrowRight size={13}/></span>}
                            />
                        </Link>
