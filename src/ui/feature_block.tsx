...
const FeatureBlock:React.FC<FeatureProp> = ({ text ,content , src} ) => {
    return(
        <div className="bg-white w-[90%] mx-auto md:w-[31%] h-fit py-4  border border-solid border-gray-300 rounded-md">
            <div className="w-[90%] mx-auto flex flex-col items-center justify-center h-[350px] gap-3">
                ...
                <div className="grid space-y-4">
                    ...
                    <p className="text-md tracking-wide leading-6 text-gray-400">{content}</p>
                </div>
            </div>  
        </div>
    )
