...
const Contact = () => {
    return(
        ...
        <div id='contact' className="bg-[#F9FAFB] p-6 md:p-10 h-[250px] flex flex-col justify-center md:gap-5 gap-10 w-[90%] mx-auto  rounded-md">
         ...
         <a
            href="mailto:support@textflex.net"
            className="text-[15px] h-12 md:text-lg text-blue-400 underline flex items-center gap-1"
            >
            📧 Email: support@textflex.net <ArrowRight size={20} />
            </a>
        </div>
