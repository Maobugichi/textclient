...
const HeroImg = () => {
    return(
        <div className="h-[355px]  w-full md:w-1/2 md:h-[90vh] md:relative md:right-[-120px] shadow-2xl rounded-lg p-1 border border-solid border-blue-400 overflow-hidden">
