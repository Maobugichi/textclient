        ...
        <AnimatePresence>
         {
            ...
            (show && <motion.nav
                ...
                exit={{ x: -500}}
                className={`fixed z-20 font-montserrat w-[60%] md:w-[20%] md:fixed h-[100vh] top-0 md:flex flex-col gap-5  border-r border-solid  ${theme ? 'bg-[#242424] border-blue-100' : 'bg-[#f9fbfd] border-[#5252]'}`}>
                   <div className={`h-16 flex items-center justify-around  border-b border-solid border-[#5252] ${theme ? 'border-blue-100': 'border-[#5252]'}`}>
                   <Link to="/homepage/1">
                         { textlogo ? (<img className="w-[100px]" src={textlogo} alt="logo" />) : (<Skeleton className="w-[80%] h-32  md:h-32 rounded-md" baseColor="#333333" highlightColor="#f5f5f5" /> ) }
                    </Link>
                ...
                (<nav
                className={`fixed font-montserrat z-20 md:w-[20%] h-[100vh] top-0 md:flex flex-col gap-5  border-r border-solid  ${theme ? 'bg-[#242424] border-blue-100' : 'bg-[#f9fbfd] border-[#5252]'}`}>
