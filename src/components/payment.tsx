...
const Payment = () => {
  ...
  const [ isActive , setIsActive ] = useState<any>('squad')
        ...
        <div className="md:w-[40%]  flex flex-col gap-4">
          ...
          <div className="flex gap-2">
            <div id='squad' onClick={active} className="relative rounded-full w-20 h-8 grid transition-all duration-300 ease-out place-items-center border border-solid border-gray-300">
              <CheckCircle className={`absolute top-[-5px] right-[-5px] `} color="green" size={20}/>
             ...
             <div id='now' onClick={active} className="relative rounded-full w-20 h-8 grid transition-all duration-300 ease-out place-items-center border border-solid border-gray-300">
              <CheckCircle className={`absolute top-[-5px] right-[-5px] `} color="green" size={20}/>
