  ...
  useEffect(() => {
    ...
    return(
      <div className={`h-[50vh] md:h-[80vh] w-full flex flex-col  gap-4 ${theme ? 'text-white' : 'text-black'}`}>
        ...
        <div>
          <div onClick={active} className="relative rounded-full w-20 h-8 grid transition-all duration-300 ease-out place-items-center border border-solid border-gray-300">
            <CheckCircle className={`absolute top-[-5px] right-[-5px] ${showCheck ? 'block' : 'hidden'}`} color="green" size={20}/>
